...
cd /ExaHyPE-Tsunami/ApplicationExamples/SWE && sed -i "s/\"background_job_consumers\": .*/\"background_job_consumers\": $consumers/g" SWE_asagi_limited_l0.exahype2
cd /ExaHyPE-Tsunami/ApplicationExamples/SWE && sed -i "s/\"background_job_consumers\": .*/\"background_job_consumers\": $consumers/g" SWE_asagi_limited_l1.exahype2
cd /ExaHyPE-Tsunami/ApplicationExamples/SWE && sed -i "s/\"background_job_consumers\": .*/\"background_job_consumers\": $consumers/g" SWE_asagi_limited_l2.exahype2
